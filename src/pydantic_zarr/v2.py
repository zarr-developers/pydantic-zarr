...
class GroupSpec(BaseGroupSpec, Generic[TMembers]):
    ...
    def to_flat(self, root_path: str = "") -> dict[str, ArraySpec | AnyGroupSpec]:
        """
    ...
    @classmethod
    def from_flat(cls, data: Mapping[str, ArraySpec | AnyGroupSpec]) -> Self:
        """
...
def from_zarr(element: zarr.Array | zarr.Group, depth: int = -1) -> ArraySpec | AnyGroupSpec:
    """
...
def to_flat(
    node: ArraySpec[Any] | GroupSpec[Any], root_path: str = ""
    ...
    if isinstance(node, ArraySpec):
        ...
        model_copy = BaseGroupSpec(attributes=node.attributes)
...
def from_flat(data: Mapping[str, ArraySpec | BaseGroupSpec]) -> ArraySpec | GroupSpec:
    """
...
def from_flat_group(data: Mapping[str, ArraySpec | BaseGroupSpec]) -> AnyGroupSpec:
    """
    ...
    submember_by_parent_name: dict[str, dict[str, ArraySpec | AnyGroupSpec]] = {}
    ...
    try:
        ...
        root_node = GroupSpec(attributes={}, members={})
